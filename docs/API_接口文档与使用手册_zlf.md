...
| 完整地址 | `http://aiszcloud.cn:8080/v1/openapi/zlx/querySrmxZLF`（或 `http://aiszcloud.com.cn:8080/v1/openapi/zlx/querySrmxZLF`） |
...
| 完整地址 | `http://aiszcloud.cn:8080/v1/openapi/zlx/quotaZLF`（或 `http://aiszcloud.com.cn:8080/v1/openapi/zlx/quotaZLF`） |
